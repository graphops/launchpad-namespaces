...
> **Note**
> On the path to the helmfile, you can use the query string's ref `(?ref=avalanche-latest)` to track one of the release streams: `stable` and `canary`, pin to a specific version or just track a particular major or minor semantic version.
...
avalanche.resourceLabels | object |  | Adds labels to resources on this release |
