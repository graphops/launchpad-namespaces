...
#namespaces: {
	...
	#firehoseEthereum: {
		...
		#flavor: {
			...
			#enum: ( #eth_mainnet | #eth_sepolia | #arbitrum_one | #arbitrum_sepolia | #polygon_mainnet | #geo_one | #base_mainnet)
		}
		...
		defaults: {
			...
			"base-mainnet": {
				#common
				features: []
				targetNamespace: "fh-base-mainnet"
			}
		}
		...
		releases: {
			"firehose-ethereum": {
				...
				_template: {version: "0.1.0-canary.13"}
			}
