...
> **Note**
> On the path to the helmfile, you can use the query string's ref `(?ref=celo-latest)` to track one of the release streams: `main` and `canary`, pin to a specific version or just track a particular major or minor semantic version.
